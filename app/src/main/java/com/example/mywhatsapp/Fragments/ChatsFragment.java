...
//        Getting the data for the adapter
        UsersAdapter adapter;
        adapter = new UsersAdapter(list, getContext());
        binding.chatRecyclerView.setAdapter(adapter);

//        Setting the layout of the components of the recycler view.
...
//                    To skip the logged in user from being displayed in the chats fragment.
