...
public class StatusViewer extends AppCompatActivity implements StoriesProgressView.StoriesListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storiesProgressView.setBackgroundColor(getResources().getColor(R.color.chat_background));
    ...
    public void onComplete() {
        ...
        Intent i = new Intent(StatusViewer.this, StatusFragment.class);
        startActivity(i);
        finish();
    }
